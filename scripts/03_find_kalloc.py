...
KALLOC_SYMS = [
    ...
    "kalloc_type_impl", "kalloc_data_external", "kalloc_ext",
    "kfree_type_impl", "kfree_ext", "zalloc_ext", "zfree_ext",
]
...
lines.append("")
lines.append("--- KNOWN NECP STRUCT OFFSETS (from necp_dump_offsets analysis) ---")
